...
public final class CameraConfigurationUtils {
  ...
  public static void setFocus(Camera.Parameters parameters,
    ...
    if (focusMode != null) {
      if (focusMode.equals(parameters.getFocusMode())) {
    	...
    	Log.i(TAG, "Focus mode will be set to " + focusMode);
  ...
  public static void setInvertColor(Camera.Parameters parameters) {
	...
	public static Point findMaxPreviewSizeValue(Camera.Parameters parameters,
	...
	public static Point findMaxPictreSizeValue(Camera.Parameters parameters,
			Point screenResolution) {
		...
		Camera.Size largestPictureSize = supportedPreviewSizes.get(0);
		Point largestSize = new Point(largestPictureSize.width,
